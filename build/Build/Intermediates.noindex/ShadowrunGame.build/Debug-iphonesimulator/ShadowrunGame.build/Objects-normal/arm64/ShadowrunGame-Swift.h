...
#ifndef SHADOWRUNGAME_SWIFT_H
#define SHADOWRUNGAME_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ShadowrunGame",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13ShadowrunGame11BattleScene")
...
SWIFT_CLASS("_TtC13ShadowrunGame10SpriteNode")
@interface SpriteNode : SKNode
@property (nonatomic) NSInteger tileX;
@property (nonatomic) NSInteger tileY;
@property (nonatomic, copy) NSString * _Nonnull team;
@property (nonatomic, copy) NSString * _Nonnull characterId;
@property (nonatomic, copy) NSString * _Nonnull enemyId;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
